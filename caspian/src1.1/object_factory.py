...
class CaspianObjFactory:
    ...
    def create_fun_Py(self, _f:typing.Callable, name:typing.Union[str, None]=None, _type:typing.Union[str, None]=None) -> so.ObjRefId:
        ...
        _obj = CaspianObj(
            ...
            name = _f.__name__,
            parents = [self.scopes['Fun']],
            id = _id.id,
            public = {'__name__':self.scopes['String', 'suppress_eval':True].instantiate(_f.__name__), 
    ...
    def create_primative_Py(self, _f:typing.Callable, name:typing.Union[str, None]=None, _type:typing.Union[str, None]=None) -> so.ObjRefId:
        ...
        _obj = CaspianObj(
            ...
            is_primative = True,
            o_type = _type,
            parents = [self.scopes['Primative']],
            _type = f'{"" if _type is None else _type+" "}primative::{name}',
            name = _f.__name__,
            id = _id.id,
            public = {'__name__':self.scopes['String', 'suppress_eval':True].instantiate(name), 
    ...
    def create_null_Py(self, _f:typing.Callable) -> so.ObjRefId:
        ...
        _obj = CaspianObj(
            ...
            o_type = None,
            _type = 'null',
            parents = [self.scopes['BaseClass']],
            name = _f.__name__,
            id = _id.id,
            public = {'__name__':self.scopes['String', 'suppress_eval':True].instantiate('null'), 
    ...
    def create_base_class_Py(self, _f:typing.Callable) -> so.ObjRefId:
        ...
        _obj = CaspianObjClass(
            ...
            parents = [so.NameSelf],
            id = _id.id,
            public = {'__name__':self.scopes['String', 'suppress_eval':True].instantiate('BaseClass'), 
